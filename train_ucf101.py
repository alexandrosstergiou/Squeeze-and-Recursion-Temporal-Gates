...
if __name__ == "__main__":
    ...
    train_model(sym_net=net, name='UCF101', net_name=args.network, dataset_location=args.dataset, enable_long_cycles=args.long_cycles, enable_short_cycles=args.short_cycles, **kwargs)
'''
