...
parser.add_argument('--dataset', default='HACS',
...
parser.add_argument('--model-dir', type=str, default="./results/HACS",
...
if __name__ == "__main__":
    ...
    # Creat model with all parameters initialised
    ...
    # Call main train script
    train_model(sym_net=net, name='HACS', net_name=args.network, dataset_location=args.dataset, **kwargs)
'''
